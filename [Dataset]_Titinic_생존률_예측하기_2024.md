...
```
  ...
  <div id="df-90c82cf2-0562-4917-8853-8792e9840d39" class="colab-df-container">
    <div>
<style scoped>
...
<table border="1" class="dataframe">
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-90c82cf2-0562-4917-8853-8792e9840d39')"
  ...
  <style>
    ...
    <script>
      const buttonEl =
        document.querySelector('#df-90c82cf2-0562-4917-8853-8792e9840d39 button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-90c82cf2-0562-4917-8853-8792e9840d39');
        const dataTable =
...
<div id="df-b1eb3a2b-14e8-4288-961c-c8859061cb1f">
  <button class="colab-df-quickchart" onclick="quickchart('df-b1eb3a2b-14e8-4288-961c-c8859061cb1f')"
  ...
  <script>
    ...
    (() => {
      let quickchartButtonEl =
        document.querySelector('#df-b1eb3a2b-14e8-4288-961c-c8859061cb1f button');
...
```
  ...
  <div id="df-624bd2ec-958d-4b99-82e5-490120153422" class="colab-df-container">
    <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
        vertical-align: middle;
...
<table border="1" class="dataframe">
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-624bd2ec-958d-4b99-82e5-490120153422')"
            title="Convert this dataframe to an interactive table."
            style="display:none;">
  ...
  <style>
    ...
    <script>
      const buttonEl =
        document.querySelector('#df-624bd2ec-958d-4b99-82e5-490120153422 button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-624bd2ec-958d-4b99-82e5-490120153422');
        const dataTable =
          await google.colab.kernel.invokeFunction('convertToInteractive',
                                                    [key], {});
        if (!dataTable) return;
...
<div id="df-cfcecae3-7bb8-4a82-9bdb-fb744fbaac5d">
  <button class="colab-df-quickchart" onclick="quickchart('df-cfcecae3-7bb8-4a82-9bdb-fb744fbaac5d')"
            title="Suggest charts"
            style="display:none;">
...
<style>
  ...
  <script>
    ...
    (() => {
      let quickchartButtonEl =
        document.querySelector('#df-cfcecae3-7bb8-4a82-9bdb-fb744fbaac5d button');
      quickchartButtonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';
    })();
  </script>
...
```
  ...
  <div id="df-f6eea24d-1eca-497d-a471-4744eec2e30d" class="colab-df-container">
    <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
        vertical-align: middle;
...
<table border="1" class="dataframe">
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-f6eea24d-1eca-497d-a471-4744eec2e30d')"
            title="Convert this dataframe to an interactive table."
            style="display:none;">
  ...
  <style>
    ...
    <script>
      const buttonEl =
        document.querySelector('#df-f6eea24d-1eca-497d-a471-4744eec2e30d button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-f6eea24d-1eca-497d-a471-4744eec2e30d');
        const dataTable =
          await google.colab.kernel.invokeFunction('convertToInteractive',
                                                    [key], {});
        if (!dataTable) return;
...
<div id="df-2a535c54-715d-4990-9dd7-d672ac773dd9">
  <button class="colab-df-quickchart" onclick="quickchart('df-2a535c54-715d-4990-9dd7-d672ac773dd9')"
            title="Suggest charts"
            style="display:none;">
...
<style>
  ...
  <script>
    ...
    (() => {
      let quickchartButtonEl =
        document.querySelector('#df-2a535c54-715d-4990-9dd7-d672ac773dd9 button');
      quickchartButtonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';
    })();
  </script>
...
```
  ...
  <div id="df-3b1b81b6-6629-4f3c-a09a-563086c9bd4f" class="colab-df-container">
    <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
        vertical-align: middle;
...
<table border="1" class="dataframe">
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-3b1b81b6-6629-4f3c-a09a-563086c9bd4f')"
            title="Convert this dataframe to an interactive table."
            style="display:none;">
  ...
  <style>
    ...
    <script>
      const buttonEl =
        document.querySelector('#df-3b1b81b6-6629-4f3c-a09a-563086c9bd4f button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-3b1b81b6-6629-4f3c-a09a-563086c9bd4f');
        const dataTable =
          await google.colab.kernel.invokeFunction('convertToInteractive',
                                                    [key], {});
        if (!dataTable) return;
...
<div id="df-8b93876c-9cca-4e0b-915d-c50351f3a3ed">
  <button class="colab-df-quickchart" onclick="quickchart('df-8b93876c-9cca-4e0b-915d-c50351f3a3ed')"
            title="Suggest charts"
            style="display:none;">
...
<style>
  ...
  <script>
    ...
    (() => {
      let quickchartButtonEl =
        document.querySelector('#df-8b93876c-9cca-4e0b-915d-c50351f3a3ed button');
      quickchartButtonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';
    })();
  </script>
...
```
  ...
  <div id="df-b815d2b2-9be4-4a00-9847-35c45e2984cd" class="colab-df-container">
    <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
        vertical-align: middle;
...
<table border="1" class="dataframe">
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-b815d2b2-9be4-4a00-9847-35c45e2984cd')"
            title="Convert this dataframe to an interactive table."
            style="display:none;">
  ...
  <style>
    ...
    <script>
      const buttonEl =
        document.querySelector('#df-b815d2b2-9be4-4a00-9847-35c45e2984cd button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-b815d2b2-9be4-4a00-9847-35c45e2984cd');
        const dataTable =
          await google.colab.kernel.invokeFunction('convertToInteractive',
                                                    [key], {});
        if (!dataTable) return;
...
<div id="df-cd5b257a-e3c7-4648-a054-948a93355147">
  <button class="colab-df-quickchart" onclick="quickchart('df-cd5b257a-e3c7-4648-a054-948a93355147')"
            title="Suggest charts"
            style="display:none;">
...
<style>
  ...
  <script>
    ...
    (() => {
      let quickchartButtonEl =
        document.querySelector('#df-cd5b257a-e3c7-4648-a054-948a93355147 button');
      quickchartButtonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';
    })();
  </script>
